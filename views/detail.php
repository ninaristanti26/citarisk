      ...
      <div class="row">
         <div class="card mb-4 w-100">
            <div class="card-header d-flex justify-content-between align-items-center bg-dark text-white">
               ...
               <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalEditDebitur">
                  ✏️ Edit
               </button>
            </div>
            <div class="card-body">
...
<?php
         // Modal Edit Debitur
         foreach ($getDetail as $dataDeb) { ?>
         <div class="modal fade" id="modalEditDebitur" tabindex="-1" role="dialog" aria-labelledby="modalEditDebiturLabel" aria-hidden="true">
           <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
               <?php include("edit/edit_detail.php"); ?>
             </div>
           </div>
         </div>
         <?php } ?>
...
<!-- Optional: Validasi sederhana sebelum submit edit -->
<script>
function validEdit() {
    var form = document.forms[0]; // form di modal edit
    if (form.nama_debitur.value.trim() === '') {
        alert('Nama Debitur harus diisi');
        form.nama_debitur.focus();
        return false;
    }
