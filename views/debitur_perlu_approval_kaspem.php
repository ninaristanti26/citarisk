      ...
      <div class="row">
         <div class="card mb-4 w-100">
            <div class="card-header d-flex justify-content-between align-items-center bg-dark text-white">
               <h5 class="mb-0 text-white">📋 Data Pengajuan Perlu Approval Kaspem</h5>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-sm" id="dataTables-example" style="width: 100%;">
            ...
            <tr>
                ...
                <th scope="col">Plafon Pengajuan</th>
            ...
            <?php
                ...
                include("../getCode/getRekapPerluAppKaspem.php");
                $no = 1;
                foreach ($getRekapPerluAnalisa as $dataDeb) {
                         $no_ktp_encoded = urlencode($dataDeb['no_ktp']);
                $plafon_pengajuan = number_format($dataDeb['plafon_pengajuan']);  
            ?>
            <tr>
                <td class="text-center"><?php echo $no++; ?></td>
                <td class="text-center"><?php echo htmlspecialchars($dataDeb['update_riwayat_kredit']); ?></td>
                ...
                <td class="text-right"><?php echo htmlspecialchars($plafon_pengajuan); ?></td>
                <td class="text-center"><?php echo htmlspecialchars($dataDeb['jw_pengajuan']); ?> bulan</td>
                <td class="text-center">
                    <a href="detail?no_ktp=<?php echo $no_ktp_encoded; ?>" class="btn btn-sm btn-primary">Selengkapnya</a>
                </td>
            </tr>
            <?php } ?>
            </tbody>
