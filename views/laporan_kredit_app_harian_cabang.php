      ...
      <div class="row">
         <div class="card mb-4 w-100">
            <div class="card-header d-flex justify-content-between align-items-center bg-dark text-white">
               <h5 class="mb-0 text-white">📋 Laporan Kredit Approved Harian <?php echo $_SESSION['kode_cabang']; ?></h5>
            </div>
            <div class="card-body">
               ...
               <!-- Form Filter Tanggal -->
               <form method="GET" action="laporan_kredit_app_harian_cabang.php" class="form-inline mb-3">
