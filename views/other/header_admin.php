               ...
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        ...
                        <li><a href="data_debitur"><i class="ri-folder-chart-2-line"></i>Data Seluruh Debitur</a></li>
                        <li><a href="data_debitur_perlu_analisa?kode_cabang=<?php echo $_SESSION['kode_cabang']; ?>"><i class="ri-folder-chart-2-line"></i>Data Debitur Perlu Analisa</a></li>
                        </ul>
                     </li>
                   <li>
