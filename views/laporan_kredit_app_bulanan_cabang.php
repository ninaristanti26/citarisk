      ...
      <div class="row">
         <div class="card mb-4 w-100">
            <div class="card-header bg-dark text-white">
               <h5 class="mb-0 text-white">📋 Laporan Kredit Approved Bulanan <?php echo $_SESSION['kode_cabang']; ?></h5>
            </div>
            <div class="card-body">
               ...
               <form method="GET" action="laporan_kredit_app_bulanan_cabang.php" class="form-inline mb-3">
                     ...
                     <tbody>
                        ...
                        foreach ($getLaporanKreditCabang as $dataRiwayat) {
                           ...
                           foreach ($getPutusanKadiv as $kadiv) {
                              if ($kadiv['id_riwayat'] == $id_riwayat && $kadiv['status_kadiv'] == 'Kredit Disetujui') {
                                 $status = "Approved by Direktur Utama";
                                 foreach ($getPutusanDirut as $dirut) {
                                    if ($dirut['id_riwayat'] == $no_ktp) {
