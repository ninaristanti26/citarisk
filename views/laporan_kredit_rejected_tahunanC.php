      ...
      <div class="row">
         <div class="card mb-4 w-100">
            <div class="card-header bg-dark text-white">
               <h5 class="mb-0 text-white">📋 Laporan Kredit Rejected Tahunan <?php echo $_SESSION['kode_cabang']; ?></h5>
            </div>
            <div class="card-body">
               ...
               <form method="GET" action="laporan_kredit_rejected_tahunanC.php" class="form-inline mb-3">
