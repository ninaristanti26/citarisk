...
$stmt = $mysqli->prepare("
    ...
    JOIN putusan_analis_pusat ON 
        putusan_analis_pusat.no_ktp = data_pokok.no_ktp AND 
        putusan_analis_pusat.id_riwayat = riwayat_kredit.id_riwayat AND
        putusan_analis_pusat.id_pegawai = users.id_pegawai
...
$getPutusanAnalisPusat = $result->fetch_all(MYSQLI_ASSOC);
