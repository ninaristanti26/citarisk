...
$stmt = $mysqli->prepare("
    ...
    JOIN putusan_pinca ON 
        putusan_pinca.no_ktp = data_pokok.no_ktp AND 
        putusan_pinca.id_riwayat = riwayat_kredit.id_riwayat AND
        putusan_pinca.id_pegawai = users.id_pegawai
...
$getPutusanPinca = $result->fetch_all(MYSQLI_ASSOC);
