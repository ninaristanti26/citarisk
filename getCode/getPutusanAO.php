...
$stmt = $mysqli->prepare("
    ...
    JOIN putusan_ao ON 
        putusan_ao.no_ktp = data_pokok.no_ktp AND 
        putusan_ao.id_riwayat = riwayat_kredit.id_riwayat AND
        putusan_ao.id_pegawai = users.id_pegawai
...
$getPutusanAO = $result->fetch_all(MYSQLI_ASSOC);
