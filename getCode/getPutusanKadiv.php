...
$stmt = $mysqli->prepare("
    ...
    JOIN putusan_kadiv ON 
        putusan_kadiv.no_ktp = data_pokok.no_ktp AND 
        putusan_kadiv.id_riwayat = riwayat_kredit.id_riwayat AND
        putusan_kadiv.id_pegawai = users.id_pegawai
...
$getPutusanKadiv = $result->fetch_all(MYSQLI_ASSOC);
