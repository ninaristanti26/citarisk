...
$stmt = $mysqli->prepare("
    ...
    JOIN putusan_analis ON 
        putusan_analis.no_ktp = data_pokok.no_ktp AND 
        putusan_analis.id_riwayat = riwayat_kredit.id_riwayat AND
        putusan_analis.id_pegawai = users.id_pegawai
...
$getPutusanAnalis = $result->fetch_all(MYSQLI_ASSOC);
